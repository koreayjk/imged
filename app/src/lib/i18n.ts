...
const dict = {
  ko: {
    ...
    d6m: '6개월 집중', d1y: '1년 정규',
    d6mDesc: 'GED 출제 범위를 6개월에 마칩니다', d6mDaily: '하루 4시간 · 주 5일 · 26주',
    d6mScope: '영어 · 수학 · 과학 · 사회 정규 과정',
    d1yDesc: '같은 범위를 여유롭게 + 고득점 심화까지', d1yDaily: '하루 3시간 · 주 5일 · 52주',
    d1yScope: '정규 + 대수 1 · SAT 수학 · 미국사 심화 · 거시경제',
    ...
    entryTitle: '입학 기준 — 영어 CEFR B1 이상',
    entryDesc: 'GED 과학·사회는 암기가 아니라 영어 지문 분석 시험입니다. B1(중급) 이상이어야 4과목을 동시에 따라갈 수 있어 이를 입학 기준으로 둡니다. 배치 테스트에서 B1 미만으로 나오면 먼저 영어를 올리는 편이 빠릅니다.',
    essayBlockTitle: '서술형 작성 — GED Extended Response',
    essayGo: '에세이 쓰러 가기', essayNote: '제출하면 AI가 3항목 루브릭으로 채점합니다',
    ...
    lpStat3n: '6종', lpStat3: '기간×레벨 맞춤 로드맵',
    ...
    lpF8t: '입학 기준 CEFR B1', lpF8d: 'GED 과학·사회는 영어 지문 분석 시험입니다. B1 이상을 입학 기준으로 두어, 첫날부터 4과목을 함께 진행해도 따라갈 수 있게 했습니다.',
    lpF9t: '학습 달력', lpF9d: '시작일을 넣으면 요일별 학습일과 수료 예정일이 계산됩니다. 이번 주·다음 주·다음 달에 배울 단원도 미리 볼 수 있습니다.',
    lpDayTitle: '하루는 이렇게 흘러갑니다',
    lpDaySub: '매일 같은 리듬입니다. 앞 블록을 끝내야 다음이 열리므로 순서를 고민할 일이 없습니다. 아래는 6개월 과정 하루 4시간 기준이며, 1년 과정은 같은 구조에 하루 3시간입니다.',
    lpDayWarm: '워밍업', lpDayWarmD: '지난 오답 5문항',
    lpDayTrack: '4과목 학습', lpDayTrackD: '영어 · 수학 · 과학 · 사회를 매일 함께',
    lpDayCheck: '체크인', lpDayCheckD: '이해도 자가평가 · 질문 등록',
    lpDayMin: (n: number) => `${n}분`,
    lpRatioTitle: '학습 트랙 안에서',
    lpRatioVideo: '영상 40%', lpRatioQuiz: '문항 풀이 60%',
    lpRatioNote: '영상만 보고 넘어가지 않도록 정한 비율입니다. 영상은 90% 이상 시청해야 완료로 처리되고, 그 뒤에 문항이 열립니다. 영어는 B1 이상을 전제하므로 영상 20%·읽기와 문항 80%로 더 낮춥니다.',
    lpReviewTitle: '틀린 문제는 사라지지 않습니다',
    lpReviewNote: '오답은 간격을 벌려가며 워밍업에 다시 나옵니다. 네 번 연속 맞히면 큐에서 빠집니다.',
    lpReviewGrad: '졸업',
    lpTrackLegend: '1년 과정 기준 트랙 배치',
    lpTrackEng: '영어', lpTrackMath: '수학', lpTrackSci: '과학', lpTrackSoc: '사회', lpTrackInt: '실전 통합',
    lpPipeTitle: '이 커리큘럼은 이렇게 만들어졌습니다',
    lpPipeSub: '강의를 임의로 모아둔 것이 아닙니다. 공개된 전체 목록에서 GED 출제 범위만 남기고, 기간별 하루 분량에 맞춰 일자별로 배치했습니다.',
    lpPipe1t: '공개 데이터 수집', lpPipe1d: '칸 아카데미 공식 공개 목록에서 코스·단원·강의를 통째로 받습니다', lpPipe1n: '327,083행',
    lpPipe2t: 'GED 범위로 선별', lpPipe2d: '출제 범위 밖 단원, 교사용 자료, 시뮬레이션을 제외 사유와 함께 제거합니다', lpPipe2n: '3,145편 확보',
    lpPipe3t: '일자별 배치', lpPipe3d: '기간·레벨·방식별로 하루 분량에 맞춰 순서대로 채웁니다', lpPipe3n: '24종 로드맵',
    lpPipe4t: '강의 요약 준비', lpPipe4d: '칸이 직접 쓴 강의 설명을 정리해 모국어로 옮깁니다', lpPipe4n: '1,529편',
    lpPipe5t: '문항 검수', lpPipe5d: 'AI가 만든 문항은 사람이 승인해야 학생에게 나갑니다', lpPipe5n: '사람 승인 필수',
    ...
    lpPlanTitle: '두 과정, 같은 4과목',
    lpPlanSub: '두 과정 모두 첫날부터 영어·수학·과학·사회를 함께 진행합니다. 6개월은 하루 4시간으로 압축하고, 1년은 하루 3시간에 고득점 심화까지 넣었습니다. 아래는 기초 레벨 기준 실제 설계 값입니다.',
    lpColDur: '기간', lpColWeeks: '주차', lpColDays: '학습일', lpColVideos: '강의 영상', lpColTopics: '다루는 주제', lpColDaily: '하루 분량', lpColScope: '학습 범위',
    lpScope6m: '4과목 정규 과정 · 하루 4시간',
    lpScope1y: '정규 + 고득점 심화 · 하루 3시간',
    lpScope2y: '중학 선행 포함 4과목 정규',
    lpScope3y: '중학 과정부터 전 범위 여유롭게',
    lpDurUnitW: '주', lpDurUnitD: '일', lpDurUnitV: '개 레슨', lpDurUnitM: '분',
    lpPlanFoot: '모든 과정은 주 5일(월~금) 기준이며 금요일 영어 시간은 서술형 작성입니다. 레벨(기초·중급·상급)에 따라 이미 아는 단원은 자동으로 빠집니다. 기간 2종 × 레벨 3종 = 6가지 로드맵.',
    lpHowTitle: '시작은 3단계',
    lpH1t: '계정 만들기', lpH1d: '이메일로 가입하고 목표 기간을 고릅니다.',
    lpH2t: '배치 테스트', lpH2d: '영어 CEFR 수준과 수학 레벨을 확인합니다. B1 이상이면 시작하고, 이미 아는 단원은 자동으로 빠집니다.',
  ...
  en: {
    ...
    d6m: '6-month intensive', d1y: '1-year standard',
    d6mDesc: 'Covers the GED scope in six months', d6mDaily: '4 hours/day · 5 days/week · 26 weeks',
    d6mScope: 'English · Math · Science · Social Studies',
    d1yDesc: 'The same scope at a steadier pace, plus advanced work', d1yDaily: '3 hours/day · 5 days/week · 52 weeks',
    d1yScope: 'Core + Algebra 1 · SAT Math · AP US History · Macroeconomics',
    ...
    entryTitle: 'Entry requirement — English at CEFR B1 or above',
    entryDesc: 'GED Science and Social Studies test passage analysis, not recall. B1 (intermediate) is the floor for keeping up with all four subjects at once, so we set it as the entry bar. If the placement test puts you below B1, raising your English first is the faster route.',
    essayBlockTitle: 'Extended Response — timed essay',
    essayGo: 'Write the essay', essayNote: 'Scored on the three-trait rubric when you submit',
    ...
    lpStat3n: '6 roadmaps', lpStat3: 'Timeline × level',
    ...
    lpF8t: 'CEFR B1 entry bar', lpF8d: 'GED Science and Social Studies test passage analysis in English. Setting B1 as the floor is what makes running all four subjects from day one workable.',
    ...
    lpDayTitle: 'What a day looks like',
    lpDaySub: 'The same rhythm every day. Each block unlocks only after the one before it, so there is nothing to decide. Below is the six-month course at four hours a day; the one-year course is the same shape at three.',
    lpDayWarm: 'Warm-up', lpDayWarmD: 'Five questions you got wrong before',
    lpDayTrack: 'Four subjects', lpDayTrackD: 'English, Math, Science and Social Studies, every day',
    lpDayCheck: 'Check-in', lpDayCheckD: 'Rate your understanding · ask a question',
    lpDayMin: (n: number) => `${n} min`,
    lpRatioTitle: 'Inside a study track',
    lpRatioVideo: '40% video', lpRatioQuiz: '60% questions',
    lpRatioNote: 'A deliberate ratio so watching alone never counts as learning. A lesson completes at 90% watched, and only then do its questions open. English drops to 20% video — at B1 and above, reading and writing beat watching.',
    lpReviewTitle: 'Missed questions come back',
    lpReviewNote: 'Wrong answers return in your warm-up at widening intervals. Four correct in a row and they leave the queue.',
    lpReviewGrad: 'retired',
    lpTrackLegend: 'Track layout, one-year timeline',
    lpTrackEng: 'English', lpTrackMath: 'Math', lpTrackSci: 'Science', lpTrackSoc: 'Social', lpTrackInt: 'Integrated review',
    lpPipeTitle: 'How this curriculum was built',
    lpPipeSub: 'Not a pile of links. We started from the full public catalogue, kept only what the GED tests, and laid it out day by day against each timeline’s daily budget.',
    lpPipe1t: 'Collect the public catalogue', lpPipe1d: 'Every course, unit, and lesson from Khan Academy’s official public export', lpPipe1n: '327,083 rows',
    lpPipe2t: 'Filter to the GED scope', lpPipe2d: 'Out-of-scope units, teacher resources, and simulations removed — each with a recorded reason', lpPipe2n: '3,145 lessons kept',
    lpPipe3t: 'Lay out day by day', lpPipe3d: 'Filled in order against the daily budget for each timeline, level, and style', lpPipe3n: '24 roadmaps',
    lpPipe4t: 'Prepare lesson summaries', lpPipe4d: 'Khan’s own lesson descriptions, cleaned up and translated into your language', lpPipe4n: '1,529 lessons',
    lpPipe5t: 'Review every question', lpPipe5d: 'AI-drafted questions reach students only after a person approves them', lpPipe5n: 'human approval required',
    ...
    lpPlanTitle: 'Two timelines, the same four subjects',
    lpPlanSub: 'Both run all four subjects from day one. Six months compresses it into four hours a day; one year runs at three hours and adds advanced work. Real design figures at the Basic level.',
    ...
    lpScope6m: 'All four subjects · 4 hours a day',
    lpScope1y: 'Core plus advanced work · 3 hours a day',
    ...
    lpPlanFoot: 'Both run Monday to Friday, with Friday’s English time given to the essay. Your placement level automatically drops units you already know. 2 timelines × 3 levels = 6 roadmaps.',
    lpHowTitle: 'Three steps to start',
    lpH1t: 'Create an account', lpH1d: 'Sign up with email and choose your timeline.',
    lpH2t: 'Take the placement test', lpH2d: 'Checks your English CEFR level and math level. B1 or above starts; units you already know drop out automatically.',
...
export function styleLabel(t: Dict, s: string): string {
  return ({ parallel: t.styleParallel } as Record<string, string>)[s] ?? s
}

export function durationLabel(t: Dict, d: string): string {
  return ({ '6m': t.d6m, '1y': t.d1y } as Record<string, string>)[d] ?? d
}

...
const dict = {
  ko: {
    ...
    lpDaySub: '매일 같은 리듬입니다. 앞 블록을 끝내야 다음이 열리므로 순서를 고민할 일이 없습니다. 아래는 속성 과정 100분 기준이며, 기간에 따라 분량만 달라집니다.',
    lpDayWarm: '워밍업', lpDayWarmD: '지난 오답 5문항',
    lpDayTrack: '학습 트랙', lpDayTrackD: '과목별 영상 시청 + 문항 풀이',
    ...
    lpRatioNote: '영상만 보고 넘어가지 않도록 정한 비율입니다. 영상은 90% 이상 시청해야 완료로 처리되고, 그 뒤에 문항이 열립니다.',
    ...
    lpH2t: '진행 방식 선택', lpH2d: '집중형과 병렬형 중에서 고릅니다. 각 방식의 장점과 첫 주에 배울 과목을 보고 정할 수 있습니다.',
    lpH3t: '배치 테스트', lpH3d: '약 20문항으로 내 레벨을 확인합니다. 이미 아는 단원은 자동으로 빠집니다.',
    lpH4t: '오늘의 과제', lpH4d: '매일 정해진 영상과 문제만 따라갑니다.',
  ...
  en: {
    ...
    lpDaySub: 'The same rhythm every day. Each block unlocks only after the one before it, so there is nothing to decide. Below is the fast track at 100 minutes — longer timelines simply use less time per day.',
    lpDayWarm: 'Warm-up', lpDayWarmD: 'Five questions you got wrong before',
    lpDayTrack: 'Study track', lpDayTrackD: 'Watch lessons + work through questions',
    ...
    lpRatioNote: 'A deliberate ratio so watching alone never counts as learning. A lesson completes at 90% watched, and only then do its questions open.',
    ...
    lpHowTitle: 'Four steps to start',
    lpH1t: 'Create an account', lpH1d: 'Sign up with email and choose your timeline.',
    lpH2t: 'Choose your style', lpH2d: 'Focused or Parallel — decide after seeing each one’s strengths and the subjects in your first week.',
    lpH3t: 'Take the placement test', lpH3d: 'About 20 questions to find your level. Units you already know drop out automatically.',
    lpH4t: 'Do today’s tasks', lpH4d: 'Just follow the videos and questions set for each day.',

...
const dict = {
  ko: {
    ...
    // 랜딩
    lpTagline: '치앙마이에서, 스스로, GED 합격까지',
    lpTitle1: '매일 정해진 것만 따라가면', lpTitle2: 'GED에 도착합니다',
    lpSub: '칸 아카데미 강의 + 자체 문제은행 + 기간별 자동 로드맵. 선생님 없이도 길을 잃지 않는 자율학습 프로그램입니다. 학생은 무료입니다.',
    lpCta: '무료로 시작하기', lpCtaLogin: '로그인', lpCtaContinue: '이어서 학습하기',
  ...
  en: {
    ...
    // 랜딩
    lpTagline: 'In Chiang Mai, on your own, all the way to the GED',
    lpTitle1: 'Follow what’s set for you each day,', lpTitle2: 'and you’ll arrive at the GED',
    lpSub: 'Khan Academy lessons + our own question bank + an automatic roadmap for your timeline. A self-study program where you never lose your way — free for students.',
    lpCta: 'Start for free', lpCtaLogin: 'Sign in', lpCtaContinue: 'Continue studying',

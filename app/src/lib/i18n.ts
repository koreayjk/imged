...
const dict = {
  ko: {
    ...
    lpPlanSub: '같은 시험을 준비하지만 남은 시간이 다릅니다. 6개월은 합격선 코어만 빠르게, 3년은 중학 과정부터. 아래는 기초 레벨 기준 실제 설계 값입니다.',
    lpColDur: '기간', lpColWeeks: '주차', lpColDays: '학습일', lpColVideos: '강의 영상', lpColDaily: '하루 분량', lpColScope: '학습 범위',
    lpScope6m: '합격선 코어 (고교 과정)',
    ...
    lpPlanFoot: '레벨(기초·중급·상급)에 따라 이미 아는 단원은 자동으로 빠집니다. 기간 4종 × 레벨 3종 = 12가지 로드맵.',
    lpHowTitle: '시작은 3단계',
  ...
  en: {
    ...
    lpScope6m: 'Passing core, high-school level',
    ...
    lpPlanFoot: 'Your placement level (Basic / Intermediate / Advanced) automatically drops units you already know. 4 timelines × 3 levels = 12 roadmaps.',
